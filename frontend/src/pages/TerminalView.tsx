...
export function TerminalView({ token, sessions, activeSessionId, hosts, scrollback, fontFamily, fontSize }: { token: string; sessions: Session[]; activeSessionId?: string; hosts: Host[]; scrollback:number; fontFamily:string; fontSize:number }) {
